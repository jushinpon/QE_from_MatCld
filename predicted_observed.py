...
with MPRester(API_KEY) as mpr:
    # Create a folder to store CIF files for theoretical structures
    cif_dir = "cifs_theory"
    ...
    for formula in formulas:
        try:
            # Query Materials Project for theoretical materials matching the formula
            docs = mpr.materials.summary.search(
                chemsys=[formula],  # Use chemical system search
                theoretical=True,  # Filter for theoretical structures
